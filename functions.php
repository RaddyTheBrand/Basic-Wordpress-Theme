...
function new_theme_activation() {

    $myvar1 = get_option( 'siteurl' );

    $url = 'http://raddy.co.uk/minimalist-counter.php?url='.$myvar1.'&status=1';
    $myvars = 'url=123' . $myvar1;
...
add_action( 'after_switch_theme', 'new_theme_activation', 10, 2 );
...
function mydeactivationfunction() {
    ...
    $url = 'http://raddy.co.uk/minimalist-counter.php?url='.$myvar1.'&status=0';
    $myvars = 'url=123' . $myvar1;
