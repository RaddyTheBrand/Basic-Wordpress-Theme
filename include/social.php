    ...
    <div class="networks">
        <?php   
            ...
            if($basicFacebook != "") {
                echo "<a href='$basicFacebook' target='_blank'>
            ...
            if($basicInstagram != "") {
                echo "<a href='$basicInstagram' target='_blank'>
            ...
            if($basicPinterest != "") {
                echo "<a href='$basicPinterest' target='_blank'>
            ...
            if($basicRSS != "") {
                echo "<a href='$basicRSS' target='_blank'>
            ...
            if($basicSkype != "") {
                echo "<a href='skype:$basicSkype?chat' target='_blank'>
            ...
            if($basicSnapchat != "") {
                echo "<a href='https://www.snapchat.com/add/$basicSnapchat' target='_blank'>
            ...
            if($basicTwitter != "") {
                echo "<a href='$basicTwitter' target='_blank'>
            ...
            if($basicWeChat != "") {
                echo "<a href='https://msng.link/wc/$basicWeChat' target='_blank'>
            ...
            if($basicWhatsApp != "") {
                echo "<a href='https://api.whatsapp.com/send?phone=$basicWhatsApp' target='_blank'>
            ...
            if($basicYouTube != "") {
                echo "<a href='$basicYouTube' target='_blank'>
            ...
            if($basicEmail != "") {
                echo "<a href='mailto:$basicEmail' target='_blank'>
